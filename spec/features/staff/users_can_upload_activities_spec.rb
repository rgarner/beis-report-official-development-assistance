RSpec.feature "users can upload activities" do
  ...
  let!(:programme) { create(:project_activity, :newton_funded, organisation: organisation, roda_identifier_fragment: "B-PROG", parent: create(:fund_activity, roda_identifier_fragment: "A-FUND")) }
  ...
  context "uploading a set of activities the user doesn't have permission to modify" do
    ...
    let!(:another_project) { create(:project_activity, parent: programme.associated_fund, organisation: another_organisation, roda_identifier_fragment: "BB-PROG") }
